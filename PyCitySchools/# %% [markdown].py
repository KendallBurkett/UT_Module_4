...
# I got stuck on the bins in the following steps and had to have help from Chat GPT for converting the dtype of "Per Student Budget"
...
school_spending_df["Spending Ranges (Per Student)"] = pd.cut(school_spending_df["Per Student Budget"], labels=labels, bins=spending_bins)
school_spending_df
